...
class _ReviewSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final baseItems = [
      ...
      _ReviewSummaryItem(
        enumKey: 'GOOD_FOR_SOLO',
        emoji: '🍽️',
        label: '혼밥하기 좋아요',
        order: 3,
      ),
      _ReviewSummaryItem(
        enumKey: 'GOOD_FOR_GROUPS',
        emoji: '👥',
        label: '단체로 오기 좋아요',
        order: 4,
      ),
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: ranked ? FontWeight.w700 : FontWeight.w600,
